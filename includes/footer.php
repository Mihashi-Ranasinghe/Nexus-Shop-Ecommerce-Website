	...
	<div class="footer-nav">
		<div class="container clearfix">
			...
			<div class="footer-nav__col footer-nav__col--contacts">
				...
				Head Office: Nexus Fashion.<br>
				180-182 Negombo Rd, Wattala.
			</address>
				<div class="phone">
					Telephone:
					<a class="phone__number" href="tel:0123456789">0112-910-436</a>
				</div>
				<div class="email">
					Email:
					<a href="mailto:support@yourwebsite.com" class="email__addr">nexusfashion@gmail.com</a>
				</div>
			</div>
	...
	<div class="banners">
		<div class="container clearfix">
			...
			<div class="banner-award">
				<span>Nexus-Fashion</span><br> Connect to the deal
			</div>
